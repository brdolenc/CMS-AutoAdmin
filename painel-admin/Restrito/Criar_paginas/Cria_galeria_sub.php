	...
	if(isset($_POST[\'editar\'])) {
		...
		$id_edit     = mysql_real_escape_string($_POST[\'id_edit\']);
			...
			$UpTexto = mysql_query("UPDATE ".$Banco." SET titulo= \'$Titulo\', texto= \'$Texto\' WHERE id = \'$id_edit\'")or(die(mysql_error()));
				...
				if($UpTexto) {
							  echo \'<script type="text/javascript"> location.href="?pg=\'.$Pagina.\'&id=\'.$_GET[\'id\'].\'&alert_edit=1&Id_Princ=\'.$id_Principal.\'"; </script>\';
							}else{
							  echo \'<script type="text/javascript"> location.href="?pg=\'.$Pagina.\'&id=\'.$_GET[\'id\'].\'&alert_edit=2&Id_Princ=\'.$id_Principal.\'"; </script>\';
				}
...
Ferramentas > <a href="?pg=paginas/<?php echo $Ferramenta_principal?>/<?php echo $Ferramenta_principal?>"><?php echo $Ferramenta_principal?></a> > <a href="?pg=paginas/<?php echo $Titulo_banco?>/<?php echo $Titulo_banco?>&Id_Princ=<?php echo $_GET[\'Id_Princ\']?>"><?php echo $Titulo_banco?></a>  > galeria
...
while($retorna = mysql_fetch_array($sql)) {
		...
		echo \'<li class="Imagens_box" id="arrayorder_\'.$id.\'">\';
			...
			echo "<a href=\'?pg=".$Pagina."&id=".$_GET[\'id\']."&texto=".$retorna[\'id\']."&Id_Princ=".$id_Principal."\'>";
            ...
            <a href="?pg=../Sistema/Includes/capa&banco=<?php echo $Banco?>&status=<?php echo $retorna[\'capa\']?>&pagina=<?php echo $Pagina?>&id_gal=<?php echo $retorna[\'id\']?>&id=<?php echo $id_Gal?>&Id_Princ=<?php echo $id_Principal?>">
            ...
            <?
			echo "<a href=\'?pg=".$Pagina."&id=".$_GET[\'id\']."&idEx=".$retorna[\'id\']."&Id_Princ=".$id_Principal."\'>";
