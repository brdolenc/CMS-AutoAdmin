...
$Conteudo_Pagina_Edit .= '
		...
		GravaAcoes($_SESSION[\'idLogin\'],$_SESSION[\'UserLogin\'],$Nome_Banco,"Editar",$'.$Campo_principal.',$ParmaLK,false);
}
...
';
$Criar_CAD = fopen ("Restrito/paginas/".$Titulo_banco."/".$Titulo_banco."_editar_restaurar.php", "w");
