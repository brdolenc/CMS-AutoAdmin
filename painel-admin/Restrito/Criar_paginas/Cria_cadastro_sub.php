...
$Conteudo_Pagina_Cad .= '
       $cad = mysql_query("INSERT INTO ".$Nome_Banco." SET permalink = \'".$Permalink."\', id_sub = \'$id_Principal\', 
	   ';
...
$Conteudo_Pagina_Cad .= '
		...
		GravaAcoes($_SESSION[\'idLogin\'],$_SESSION[\'UserLogin\'],$Nome_Banco,"Cadastrar",$'.$Campo_principal.',$Permalink,$id_Principal);
}

if($cad) {
					
	echo \'<script type="text/javascript"> location.href="?pg=paginas/\'.$Nome_Pagina_Principal.\'/\'.$Nome_Pagina_Principal.\'&alert_inc=1&Id_Princ=\'.$id_Principal.\'"; </script>\';
...
$Criar_CAD = fopen ("Restrito/paginas/".$Titulo_banco."/".$Titulo_banco."_cadastrar.php", "w");
