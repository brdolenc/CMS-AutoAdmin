...
if(isset($_SESSION['idLogin']) and isset($_SESSION['UserLogin']) and isset($_SESSION['NivelLogin'])) {
    ...
    //CHAMA AS CLASSES
	include ("Restrito/Contrutor/Classe_Criar_sub.php");
	...
	$Campo          = $_POST['campo'];
	$sub_ferramenta = $_POST['sub_ferramenta'];
	$Tipo           = $_POST['tipo'];
    ...
    $CLS->Resgata('Referencia',$Referencia,'Campo',$Campo,'Tipo',$Tipo,'Tamanho',$Tamanho,$QTD,$Nome_tabela,$sub_ferramenta,$galeria,$upload,$post_destaque,$Sitema_comente,$categorias);
